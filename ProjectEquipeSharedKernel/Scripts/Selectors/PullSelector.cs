...
public class PullSelector : ClickSelector, IGetItemOnHand
{
    ...
    {
        return Vector3.Distance(playerController.transform.position, this.transform.position) > HandController.minDistanceToEnableInteraction;
    }
