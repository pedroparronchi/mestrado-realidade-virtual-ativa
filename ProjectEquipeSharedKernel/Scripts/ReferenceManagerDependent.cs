...
public class ReferenceManagerDependent : SingletonGameObject<ReferenceManagerDependent>
{
    ...
    HandController handsController;
    public HandController HandsController { get => handsController; }
    ...
    void FindAssets()
    {
        handsController = (HandController)FindObjectOfType(typeof(HandController));
        if (!HandsController)
